...
The essential dependencies for running the {staRgate} package include: {openCyto}, {flowAI}, {flowCore}, and {flowWorkspace}.

For a complete example and illustrative purposes, these packages are called in the vignette but not required for {staRgate} to run: {ggplot2}, {ggCyto}, {gt}
