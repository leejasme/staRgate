...
The following packages are needed to fully run the pipeline as shown in this Tutorial, but not required for the {staRgate} code chunks to run: `r BiocStyle::Biocpkg("openCyto")`, `r BiocStyle::Biocpkg("flowAI")`, `r BiocStyle::CRANpkg("ggplot2")`, `r BiocStyle::Biocpkg("ggcyto")`, `r BiocStyle::CRANpkg("gt")`
