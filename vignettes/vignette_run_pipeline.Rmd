...
+---------------+-----------------+-------------------------------------------------------------------------+
| TRUE          | TRUE            | - Combinations of positive/negative for pairs of markers in `num_marker`|
|               |                 | - Combinations of positive/negative for marker(s) in `denom_marker` and |
|               |                 |   combinations of positive/negative for marker(s) in `denom_marker` with|
|               |                 |   one marker from `num_marker` positive/negative                        |
+---------------+-----------------+-------------------------------------------------------------------------+
...
# For display, group based on the CD4/CD8 subsets
example_perc1 %>% 
  # dplyr::mutate(subset = 
  #                 dplyr::case_when(
  #                   grepl("_OF_CD4_POS_CD8_POS", subpopulation) ~ "CD4+/CD8+",
  #                   grepl("_OF_CD4_POS_CD8_NEG", subpopulation) ~ "CD4+/CD8-",
  #                   grepl("_OF_CD4_NEG_CD8_POS", subpopulation) ~ "CD4-/CD8+",
  #                   grepl("_OF_CD4_NEG_CD8_NEG", subpopulation) ~ "CD4-/CD8-"
  #                 )) %>% 
